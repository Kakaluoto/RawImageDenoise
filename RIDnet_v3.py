...
class RIDnet_v3(nn.Module):
    ...
    def forward(self, x):
        ...
        x_eam_1 = self.eam1(x1)
        x_eam_2 = self.eam2(x_eam_1)
        x_eam_3 = self.eam3(x_eam_2)
        # x_eam = self.eam4(x_eam)

        x_lsc = x_eam_1 + x_eam_2 + x_eam_3 + x1  # Long skip connection
...
if __name__ == "__main__":
    ...
    net = RIDnet_v3(in_channels=4, out_channels=4, num_feautres=32).cuda()
    output = net(test_input)
    torch.save(net.state_dict(), "./checkpoints/RIDnet_v3/test.pth")
    print("test over")
