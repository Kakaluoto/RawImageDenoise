...
class Unet_v2(nn.Module):
    def __init__(self, in_channels=4, out_channels=4):
        ...
        self.up_5_6 = nn.ConvTranspose2d(512, 256, 2, stride=2)
        self.upv6 = nn.ConvTranspose2d(512, 256, 2, stride=2)
        self.conv6_1 = nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1)
        self.conv6_2 = nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1)

        self.up_5_7 = nn.ConvTranspose2d(512, 128, 4, stride=4)
        self.upv7 = nn.ConvTranspose2d(256, 128, 2, stride=2)
        self.conv7_1 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv7_2 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)

        self.up_5_8 = nn.ConvTranspose2d(512, 64, 8, stride=8)
        self.upv8 = nn.ConvTranspose2d(128, 64, 2, stride=2)
        self.conv8_1 = nn.Conv2d(64, 64, kernel_size=3, stride=1, padding=1)
        self.conv8_2 = nn.Conv2d(64, 64, kernel_size=3, stride=1, padding=1)

        self.up_5_9 = nn.ConvTranspose2d(512, 32, 16, stride=16)
