...
if __name__ == "__main__":
    ...
    net = RIDnet_v2(in_channels=4, out_channels=4, num_feautres=24).cuda()
    output = net(test_input)
    torch.save(net.state_dict(), "./checkpoints/RIDnet/test.pth")
    print("test over")
